...
watch(
    () => offlineStore.offlinePosts.length,
    () => {
        localStorage.setItem(
            'OfflinePosts',
            JSON.stringify(offlineStore.offlinePosts),
        );
    },
);
...
<template>
    ...
    <body class="bg-white text-black dark:bg-gray-800 dark:text-white">
        ...
        >
            ...
            >
                <div class="ml-1 flex flex-wrap justify-center">
                ...
                <div>
                    ...
                    >
                        <span
                            class="text-md centered relative w-full whitespace-nowrap"
                        >
                            Cancel
                        </span>
                    </button>
            ...
            <Dialog
                v-if="sessionSettings.logoutConfirm"
                :size="'xs'"
                :dialogVisible="sessionSettings.logoutConfirm"
                :title="'Logout?'"
                class="fixed inset-0 z-1000"
            >
                <button
                    ...
                    @click="sessionSettings.logoutConfirm = false"
                >
                    <span
                        class="text-md centered relative w-full whitespace-nowrap"
                        >No</span
                    ...
                    >
                        ...
                        >
                            <button
                                type="button"
                                id="SelectUser"
                                class="userBtn btn-primary ml-1 h-auto px-2 text-white"
                                @click="selectUser()"
                            >
                                {{ user.pseudonym }}
                            </button>
                        ...
                        <div class="justify-content-between grid grid-cols-12">
                            <div class="col-span-8">
                                ...
                                <Link
                                    ...
                                    class="btn mx-2 px-2 py-1"
                                    :class="[
                                        sessionSettings.page !== 'ViewEntries'
                                            ? 'btn-primary'
                                            : 'btn-success',
                                    ]"
                                    @click="
                            ...
                            <div class="centered col-span-1 col-start-11">
                                <button
                                    ...
                                    @click="
                                        sessionSettings.logoutConfirm = true
                                    "
                                >
                                    Logout
                                </button>
